            ...
            <div className="container my-5">
                <div className="row">
                    <div className="col text-center">
                        <div className="alert alert-light" role="alert"><h4>¡Compra exitosa! Tu número de orden es: <b>{orderId}</b></h4></div>
                    </div>
                </div>
            </div>
        )
            ...
            <div className="row">
                <div className="col">
                    <form>
                        ...
                        <p className="mb-3 text-white">* Campo obligatorio</p>
                        <button type="button" className="btn bg-light" onClick={generarOrden}>Comprar</button>
                    </form>
                </div>
                <div className="col">
